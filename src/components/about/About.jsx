      ...
      <div className={styles.about}>
        ...
        <div className={styles.about_right}>
          <p>
            ...
            технологий: HTML, CSS3/SASS/SCSS modules/StyledComponent, JS/TS,
            React, Redux/MobX/Recoil, MUI, React-router-dom, Axios. Начал
            увлекаться этим с 2020 года. До этого я 2 года занимался разработкой
